...
## Description
A note-taking app combining front/back-end tech. Uses express.js, node.js, nodemon, vanilla js, css, and html.

(features starter-code for some of the front-end features) Made according to the following acceptance criteria from Columbia University's Fullstack Bootcamp :
